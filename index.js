// =======Options START=======
var authConfig = {
  siteName: "WAI BOT", // 网站名称
  version: "1.1.2", // 程序版本
  theme: "acrou",
  // 强烈推荐使用自己的 client_id 和 client_secret
  client_id: "942724113524-fn5qidqgme8imt29gufbu9h17eg02vro.apps.googleusercontent.com",
  client_secret: "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",
  refresh_token: "1//0dAp0jpkAbNOtCgYIARAAGA0SNwF-L9Irq95MACGUlNpSY_FYkHHfrbeS9Udx_hIa68VekJ01-zTBDn4dO_iA85lbBc8DoVoWzug", // 授权 token
  shortcut_icon: '',
  roots: [
    {
      id: "root",
...
<html>
<head>
<meta charset="utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0,maximum-scale=1.0, user-scalable=no"/> <title>${authConfig.siteName}</title> <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1"><meta name="description" content="Combining the power of Cloudflare Workers and Google Drive will allow you to index your files on the browser on Cloudflare Workers."><meta name="theme-color" content="#FF3300"><meta name="application-name" content=${authConfig.siteName}><meta name="robots" content="index, follow"><meta name="twitter:card" content="summary"><meta name="twitter:image" content=${authConfig.shortcut_icon}><meta name="twitter:description" content="Combining the power of Cloudflare Workers and Google Drive will allow you to index your files on the browser on Cloudflare Workers."><meta name="keywords" content="google, drive, classic, material, workers-script, oauth-consent-screen, google-drive, cloudflare-workers, themes"><link rel="shortcut icon" href=${authConfig.shortcut_icon}><meta property="og:site_name" content=${authConfig.siteName}><meta property="og:type" content="website"><meta property="og:image" content=${authConfig.shortcut_icon}><meta property="og:description" content="Combining the power of Cloudflare Workers and Google Drive will allow you to index your files on the browser on Cloudflare Workers."><meta property="og:title" content=${authConfig.siteName}><link rel="apple-touch-icon" href=${authConfig.shortcut_icon}><link rel="icon" type="image/png" sizes="32x32" href=${authConfig.shortcut_icon}><meta name="google-site-verification" content="OD_AXMYw-V6ID9xQUb2Wien9Yy8IJSyfBUyejYNB3CU"/><script async src="https://www.googletagmanager.com/gtag/js?id=UA-86099016-6"></script><script>window.dataLayer=window.dataLayer || []; function gtag(){dataLayer.push(arguments);}gtag('js', new Date()); gtag('config', 'UA-86099016-6');</script><script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MR47R4M');</script> <style>@import url(${themeOptions.cdn}@${themeOptions.version}/goindex-acrou/dist/style.min.css); </style> <script>window.gdconfig=JSON.parse('${JSON.stringify({version: authConfig.version, themeOptions: themeOptions,})}'); window.themeOptions=JSON.parse('${JSON.stringify(themeOptions)}'); window.gds=JSON.parse('${JSON.stringify( authConfig.roots.map((it)=> it.name) )}'); window.MODEL=JSON.parse('${JSON.stringify(model)}'); window.current_drive_order=${current_drive_order}; </script>
</head>
<body>
